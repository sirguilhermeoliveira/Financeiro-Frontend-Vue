									...
									<div class="card-body">
										<div class="example">
											<div class="media media-lg mt-0">
												<img class="mr-3" src="../../assets/images/photos/media1.jpg" alt="Generic placeholder image">
							...
							<div class="col-12">
								<div class="card Relatedpost nested-media overflow-hidden">
									...
									<div class="card-body overflow-hidden">
										<div class="example">
											<div class="media media-lg mt-0">
												<img class="mr-3" src="../../assets/images/photos/media2.jpg" alt="Generic placeholder image">
												<div class="media-body overflow-hidden">
													<h5 class="mt-0">Media heading</h5>
													Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.
													<div class="media media-lg mt-3">
														<img class="mr-3" src="../../assets/images/photos/media3.jpg" alt="Generic placeholder image">
														<div class="media-body overflow-hidden">
															<h5 class="mt-0">Media heading</h5>
															Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.
														</div>
										...
										<div class="example">
											<ul class="list-unstyled">
												<li class="media media-lg mt-0">
													<img class="mr-3" src="../../assets/images/photos/media4.jpg" alt="Generic placeholder image">
													<div class="media-body">
												...
												<li class="media media-lg my-4">
													<img class="mr-3" src="../../assets/images/photos/media5.jpg" alt="Generic placeholder image">
													<div class="media-body">
							...
							<div class="col-12">
								<div class="card Relatedpost nested-media">
									...
									<div class="card-body">
										<div class="example">
											<div class="media media-lg mt-0">
												<img class="align-self-start mr-3" src="../../assets/images/photos/media2.jpg" alt="Generic placeholder image">
												<div class="media-body">
											...
											<div class="media media-lg">
												<img class="align-self-center mr-3" src="../../assets/images/photos/media3.jpg" alt="Generic placeholder image">
												<div class="media-body">
											...
											<div class="media media-lg">
												<img class="align-self-end mr-3" src="../../assets/images/photos/media4.jpg" alt="Generic placeholder image">
												<div class="media-body">
