									...
									<div class="card-body">
										<div class="text-wrap">
											<div class="example">
												<div class="tags">
													<span class="tag">
														<span class=""><img src="../../assets/images/users/female/6.jpg" class="tag-avatar avatar" alt="img"></span>
														Victoria
													</span>
													<span class="tag">
														<span class=""><img src="../../assets/images/users/male/4.jpg" class="tag-avatar avatar" alt="img"></span>
														Nathan
													</span>
													<span class="tag">
														<span class=""><img src="../../assets/images/users/female/1.jpg" class="tag-avatar avatar" alt="img"></span>
														Alice
													</span>
													<span class="tag">
														<span class=""><img src="../../assets/images/users/female/8.jpg" class="tag-avatar avatar" alt="img"></span>
														Rose
													</span>
													<span class="tag">
														<span class=""><img src="../../assets/images/users/male/6.jpg" class="tag-avatar avatar" alt="img"></span>
														Peter
													</span>
													<span class="tag">
														<span class=""><img src="../../assets/images/users/male/2.jpg" class="tag-avatar avatar" alt="img"></span>
														Wayne
													</span>
													<span class="tag">
														<span class=""><img src="../../assets/images/users/female/7.jpg" class="tag-avatar avatar" alt="img"></span>
														Michelle
													</span>
													<span class="tag">
														<span class=""><img src="../../assets/images/users/female/5.jpg" class="tag-avatar avatar" alt="img"></span>
														Debra
													</span>
												</div>
											</div>
